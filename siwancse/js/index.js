...
function setupClickHandlers() {
    ...
    $('#last').on('click', function() {
	    ...
	    if(document.getElementById("form-step1").firstname.value.length == 0) 
			alert('請輸入真實姓名\n');
		else if(document.getElementById("form-step1").phone.value.length == 0) 
			alert('請輸入聯絡手機\n');
		else if(document.getElementById("form-step1").gender.value.length == 0) 
			alert('請輸入性別\n');
		else if(document.getElementById("form-step1").birthday.value.length == 0) 
			alert('請選擇出生年月日\n');
		else if(document.getElementById("form-step1").birthplace.value.length == 0) 
			alert('請輸入出生地\n');
		else if(document.getElementById("form-step1").school.value.length == 0) 
			alert('請輸入最高學歷\n');
		else if(document.getElementById("form-step1").address.value.length == 0) 
			alert('請輸入戶籍地址\n');
		else if(document.getElementById("form-step1").now.value.length == 0) 
			alert('請填寫現職\n');
		else{
			document.getElementById('form-step1').submit();
		}
	});

	$('#btnorC').on('click', function() {
		if($("input[name=vol]:checked").val()!='C'){		
		var a = document.getElementById("form-step-3").Name1.value;
	    var b = document.getElementById("form-step-3").Email1.value;
	    var c = document.getElementById("form-step-3").Phone1.value;
	    var d = document.getElementById("form-step-3").Nump1.value;
	    if(document.getElementById("form-step-3").Name1.value.length == 0) 
			alert('請輸入真實姓名\n');
		else if(document.getElementById("form-step-3").Phone1.value.length == 0) 
			alert('請輸入聯絡手機\n');
		 else if(document.getElementById("form-step-3").Email1.value.length == 0) 
			alert('請輸入電子信箱\n');
		else if(document.getElementById("form-step-3").Email1.value.indexOf('@') < 1 || document.getElementById("form-step-3").Email1.value.indexOf('@')==(document.getElementById("form-step-3").Email1.value.length-1) )
			alert('電子信箱輸入錯誤\n');
		else if(document.getElementById("form-step-3").Nump1.value.length == 0) 
			alert('請輸入與會人數\n');
		else{
			$('#a').val(a);
			$('#b').val(b);
...
function showEndForm($currentForm) {
	...
	var $nextForm = $('.js-form-step[data-step="' + (currentFormStep + 3) + '"]');
